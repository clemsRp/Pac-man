...
class InstructionsMenu(Interface):
    def __init__(self,
        ...
        """
        Initialize the Instructions Menu interface.
        ...
        back_button_x = int(self.menu_x + (self.menu_width -
                                           buttons_width) / 2)
        back_button_y = int(self.menu_y + self.menu_height -
                            buttons_height - padding_bottom)
    ...
    def draw_menu(self) -> None:
        """
        Draw the instructions menu panel, borders, text, and icons.
    ...
    def update(self) -> str:
        """
        Update the logic and draw elements of the instructions menu.
