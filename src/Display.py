...
class Display:
    ...
    def collision_events(self, new_x, new_y):
        ...
        future_box_x = CollisionBox(
            new_x - self.player.radius,
            base_y - self.player.radius,
        ...
        future_box_y = CollisionBox(
            self.player.x - self.player.radius,
            new_y - self.player.radius,
            self.player.radius * 2,
            self.player.radius * 2
        )
    ...
    def handle_events(self):
        ...
        self.collision_events(new_x, new_y)
